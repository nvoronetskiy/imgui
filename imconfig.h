...
// vcpkg: package `imgui` feature `disable-obsolete` (see toolchain/vcpkg/ports/imgui/portfile.cmake) uncomments the line below when that feature is enabled.
// This checkout is intended to be built with that feature (see root vcpkg.json); direct compiles without it leave obsolete helpers available.
